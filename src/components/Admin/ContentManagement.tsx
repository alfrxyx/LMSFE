...
export function ContentManagement() {
  ...
  if (user?.role !== "admin" && user?.role !== "dosen") {
    return (
      <div className="text-center py-20 bg-white rounded-3xl border uppercase tracking-widest font-black text-red-600">
        Akses Ditolak
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 p-6 md:p-10 bg-white rounded-xl border border-gray-100 shadow-sm">
      ...
      <div className="flex bg-gray-100/80 p-1.5 rounded-2xl overflow-x-auto max-w-full no-scrollbar w-fit border border-gray-100">
        {["all", "1", "2", "3", "4", "5", "6", "7", "8"].map((sem) => (
          <button
            key={sem}
            onClick={() => setSemesterFilter(sem)}
            className={`px-5 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${semesterFilter === sem ? "bg-white text-blue-600 shadow-sm" : "text-gray-400 hover:text-gray-600"}`}
          >
      ...
      <div>
          ...
          <div className="space-y-8">
            <div className="flex flex-col md:flex-row justify-end items-center gap-6">
              <button
                ...
                className="bg-blue-600 text-white px-8 py-4 rounded-2xl font-black shadow-xl hover:bg-blue-700 transition-all active:scale-95 text-xs uppercase tracking-widest flex items-center gap-2 w-full md:w-auto justify-center"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ">
              {filteredCoursesBySemester?.map((course: any) => (
                <div
                  key={course.id}
                  className="group bg-white border border-gray-100 rounded-[2.5rem] overflow-hidden hover:shadow-2xl transition-all flex flex-col shadow-sm"
                >
                  <div className="relative h-56 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md px-4 py-1.5 rounded-xl shadow-lg border border-white/50">
                  ...
                  <div className="p-8 space-y-6 flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-2">
                      <button
                        ...
                        className="flex items-center justify-center gap-2 p-3 bg-gray-50 text-blue-600 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:border-blue-100 border border-transparent transition-all"
                      >
                        <Eye size={14} /> Lihat
                      </button>
                      <button
                        ...
                        className="flex items-center justify-center gap-2 p-3 bg-gray-50 text-green-600 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:border-green-100 border border-transparent transition-all"
                      >
                        <Edit size={14} /> Edit
                      </button>
                      <button
                        onClick={() => openAddLevelModal(course)}
                        className="col-span-2 flex items-center justify-center gap-2 p-4 bg-blue-600 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-700 shadow-lg transition-all"
                      >
        ...
        {activeTab === "quizzes" && (
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-4 min-h-[70vh]">
              <div className="lg:col-span-1 border-r border-gray-50 bg-gray-50/30 p-8 space-y-6">
                <h3 className="font-black text-gray-900 uppercase text-[10px] tracking-[0.2em] mb-4">
                  Pilih Pertemuan
                </h3>
                          ...
                          {course.levels
                            ...
                            .map((lvl: any) => (
                              <button
                                ...
                                className={`w-full text-left p-4 rounded-2xl font-bold text-xs transition-all flex items-center justify-between ${selectedQuizLevel?.id === lvl.id ? "bg-blue-600 text-white shadow-lg" : "bg-white border border-gray-100 text-gray-600 hover:bg-gray-50"}`}
                              >
              ...
              <div className="lg:col-span-3 p-8 md:p-8">
                {!selectedQuizLevel ? (
                  <div className="h-full flex flex-col items-center justify-center py-20 bg-gray-50/50 rounded-3xl border-2 border-dashed border-gray-100 text-gray-400 font-black uppercase text-[10px] tracking-widest">
                    Pilih materi tipe kuis di sidebar.
                  </div>
                ) : (
                  <div className="space-y-8">
                    <div className="flex justify-between items-center border-b border-gray-100 pb-8">
                      <div>
                        ...
                        <p className="text-blue-600 font-bold text-xs uppercase mt-1">
                    ...
                    {isAddingQuestion && (
                      <form
                        ...
                        className="bg-blue-50/50 p-6 rounded-3xl border border-blue-100 space-y-8 shadow-inner"
                      >
                        <div className="flex justify-between items-center">
                          <h4 className="font-black text-blue-900 uppercase text-xs tracking-widest">
                        ...
                        <input
                          required
                          className="w-full p-6 bg-white rounded-3xl font-bold text-lg shadow-sm outline-none"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <input
                            type="number"
                            className="w-full p-5 bg-white rounded-2xl font-black text-blue-600 outline-none"
                            value={
                          ...
                          <button
                            ...
                            className="w-full p-5 bg-white text-blue-600 rounded-2xl font-black text-xs border-2 border-dashed border-blue-200"
                          >
                            TAMBAH OPSI
                          </button>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {newQuestion.options.map((opt, idx) => (
                            <div
                              key={idx}
                              className={`p-5 rounded-[2rem] flex items-center gap-4 bg-white ${opt.is_correct ? "border-2 border-green-500" : "border-2 border-transparent shadow-sm"}`}
                            >
                              <button
                                type="button"
                                onClick={() => {
                                ...
                                className={`h-8 w-8 rounded-xl flex items-center justify-center ${opt.is_correct ? "bg-green-600 text-white" : "bg-gray-100 text-gray-300"}`}
                              >
                                {opt.is_correct ? (
                        ...
                        <div className="flex justify-end gap-4 pt-6 border-t border-blue-100">
                          <button
                            type="submit"
                            className="bg-blue-600 text-white px-12 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-blue-700 transition-all"
                          >
                            Simpan Pertanyaan
                          </button>
                        </div>
                    ...
                    <div className="space-y-6">
                      {quizQuestions.map((q, idx) => (
                        <div
                          key={q.id}
                          className="bg-white p-8 rounded-[2.5rem] border border-gray-100 hover:shadow-xl transition-all group/q"
                        >
                          <div className="flex justify-between items-start mb-8">
                            <div className="flex gap-6">
                              <span className="h-12 w-12 bg-gray-900 text-white rounded-2xl flex items-center justify-center font-black text-lg">
                                {idx + 1}
                              </span>
                              <div>
                                <p className="font-black text-gray-900 text-xl leading-tight mb-2">
                                  {q.text}
                                </p>
                                <span className="bg-blue-50 text-blue-600 text-[9px] font-black px-3 py-1 rounded-lg uppercase tracking-widest">
                                  {q.points} XP Reward
                                </span>
                              </div>
                            </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pl-0 md:pl-20">
                            {q.options.map((opt: any) => (
                              <div
                                key={opt.id}
                                className={`p-5 rounded-2xl text-xs font-bold border flex items-center gap-3 transition-all ${opt.is_correct ? "bg-green-50 border-green-200 text-green-700" : "bg-gray-50/50 border-transparent text-gray-400"}`}
                              >
                                {opt.is_correct ? (
        ...
        {activeTab === "videos" && (
          <div className="text-center py-40 bg-gray-50/50 rounded-3xl border-2 border-dashed border-gray-200 text-gray-400 font-black uppercase text-xs tracking-widest">
      ...
      {isModalOpen &&
        createPortal(
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-6 md:p-8 bg-gray-900/90 backdrop-blur-xl animate-in fade-in duration-300">
            <div className="bg-white w-full max-w-3xl rounded-[32px] shadow-2xl overflow-hidden flex flex-col max-h-[85vh] relative border border-white/20 pointer-events-auto">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full p-4 bg-gray-50 rounded-2xl border-2 border-transparent focus:border-blue-500 focus:bg-white transition-all font-medium h-40 outline-none resize-none"
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="md:col-span-2">
                        ...
                        <select
                          required
                          className="w-full p-5 bg-gray-50 rounded-2xl border-2 border-transparent focus:border-blue-500 focus:bg-white transition-all font-bold outline-none text-sm"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          required
                          placeholder="0"
                          className="w-full p-5 bg-gray-50 rounded-2xl border-2 border-transparent focus:border-blue-500 focus:bg-white transition-all font-black text-blue-600 outline-none text-lg shadow-sm"
                          value={
                      ...
                      <div>
                        ...
                        <input
                          ...
                          required
                          placeholder="1"
                          className="w-full p-5 bg-gray-50 rounded-2xl border-2 border-transparent focus:border-blue-500 focus:bg-white transition-all font-black text-gray-700 outline-none text-lg shadow-sm"
                    ...
                    <div>
                      ...
                      <div className="flex bg-gray-100 p-1 rounded-xl mb-4">
                         <button 
                           ...
                           className={`flex-1 py-2 rounded-lg text-[9px] font-black uppercase tracking-widest ${thumbnailMethod === 'file' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-400'}`}
                         >
                           Upload Foto
                         </button>
                         <button 
                           ...
                           className={`flex-1 py-2 rounded-lg text-[9px] font-black uppercase tracking-widest ${thumbnailMethod === 'url' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-400'}`}
                         >
                           Link URL
                         </button>
                      </div>
                      ...
                      {thumbnailMethod === "file" ? (
                        <div className="relative group cursor-pointer">
                          ...
                          />
                          <div className="w-full p-4 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 group-hover:border-blue-400 flex items-center justify-center gap-3">
                        ...
                        <div className="space-y-3">
                           <input
                            className="w-full p-4 bg-gray-50 rounded-2xl border-2 border-transparent focus:border-blue-500 focus:bg-white font-bold outline-none text-xs"
                      ...
                      <div className="mt-4 h-32 w-full rounded-2xl border-2 border-gray-100 flex items-center justify-center overflow-hidden bg-gray-50 relative">
                ...
                <div className="pt-4 flex gap-4">
                  {isEditMode && selectedCourse && (
                    <button
                      ...
                      className="w-1/3 bg-red-50 text-red-600 py-5 rounded-[24px] font-black hover:bg-red-100 transition-all uppercase tracking-widest text-xs border border-red-100"
                    >
                      Hapus Materi
                    </button>
                  )}
                  <button
                    type="submit"
                    className={`${isEditMode && selectedCourse ? 'w-2/3' : 'w-full'} bg-blue-600 text-white py-5 rounded-[24px] font-black shadow-xl hover:bg-blue-700 transition-all uppercase tracking-widest text-xs`}
                  >
                    Simpan Materi
                  </button>
                </div>
            ...
            <div className="bg-white w-full max-w-3xl rounded-[32px] shadow-2xl overflow-hidden flex flex-col max-h-[85vh] relative border border-white/20 pointer-events-auto">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        required
                        className="w-full p-4 bg-gray-50 rounded-2xl border-2 border-transparent focus:border-blue-500 focus:bg-white transition-all font-medium h-32 outline-none resize-none"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="number"
                          className="w-full p-4 bg-gray-50 rounded-2xl border-2 border-transparent focus:border-blue-500 focus:bg-white transition-all font-black text-blue-600 outline-none"
                          value={
                      ...
                      <div className="bg-blue-50/50 p-4 rounded-2xl border-2 border-blue-100/50">
                        <label className="text-[10px] font-black text-blue-600 uppercase tracking-widest mb-2 block flex items-center gap-2">
                          <ListOrdered size={12} /> Urutan Materi
                        </label>
                        <input
                          type="number"
                          placeholder="Contoh: 1"
                          className="w-full p-4 bg-white rounded-xl border-2 border-blue-100 focus:border-blue-600 focus:ring-4 focus:ring-blue-50 transition-all font-black text-blue-600 outline-none shadow-sm"
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 gap-2">
                        {[
                          ...
                          <button
                            ...
                            className={`flex items-center gap-3 p-3 rounded-xl border-2 transition-all text-xs font-bold ${levelForm.activity_type === type.id ? "bg-blue-50 border-blue-600 text-blue-700" : "bg-white border-gray-100 text-gray-500 hover:bg-gray-50"}`}
                          >
                            <type.icon size={16} />
                            {type.label}
                          </button>
                    ...
                    {levelForm.activity_type === "video" && (
                      <div className="-2">
                        ...
                        <input
                          className="w-full p-4 bg-blue-50 rounded-2xl border-2 border-blue-100 focus:border-blue-600 outline-none"
                    ...
                    <div className="pt-4">
                      <label className="flex items-center gap-3 p-4 bg-gray-50 rounded-2xl border-2 border-transparent hover:border-blue-100 cursor-pointer transition-all">
                        <input
                          type="checkbox"
                        ...
                        <div className="flex flex-col">
                          <span className="text-xs font-black text-gray-700 uppercase tracking-widest">Kirim Pengumuman Otomatis</span>
                          <span className="text-[10px] text-gray-400 font-medium">Beritahu mahasiswa semester {selectedCourse?.semester} via Dashboard.</span>
                        </div>
                      </label>
                    </div>
                  </div>
                ...
                <div className="pt-4 border-t border-gray-100">
                  <button
                    type="submit"
                    className="w-full bg-blue-600 text-white py-5 rounded-[24px] font-black shadow-xl hover:bg-blue-700 transition-all uppercase tracking-widest text-xs"
                  >
                    Simpan Pertemuan
                  </button>
                </div>
      ...
      {isDetailModalOpen &&
        ...
        createPortal(
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-6 md:p-8 bg-gray-900/90 backdrop-blur-xl animate-in fade-in duration-300">
            <div className="bg-white w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] relative border border-white/20 pointer-events-auto">
              <div className="p-6 bg-gray-900 text-white flex justify-between items-center shrink-0">
                <div className="flex items-center gap-6">
                  <div className="h-16 w-16 rounded-[2rem] bg-blue-600 flex items-center justify-center text-white shadow-xl shadow-blue-900/50 rotate-3">
                    <FileText size={32} />
                  </div>
                  <div>
                ...
                {selectedCourse.levels?.length > 0 ? (
                  [...selectedCourse.levels]
                    ...
                    .map((lvl: any) => (
                      <div
                        key={lvl.id}
                        className="group flex items-center justify-between p-8 bg-gray-50 rounded-[2.5rem] border border-transparent hover:border-blue-200 hover:bg-white hover:shadow-xl transition-all"
                      >
                        <div className="flex items-center gap-6">
                          <div className="h-14 w-14 bg-white rounded-2xl shadow-sm flex items-center justify-center font-black text-xl text-blue-600 border border-gray-100 group-hover:scale-110 transition-transform">
                            {lvl.order}
                          </div>
                          <div>
                            <h5 className="font-black text-gray-900 text-lg leading-tight mb-2">
                              {lvl.title}
                            </h5>
                            <div className="flex flex-wrap items-center gap-3">
                              <span className="text-[9px] font-black bg-blue-100 text-blue-600 px-3 py-1 rounded-lg uppercase tracking-widest">
                                {lvl.activity_type}
                              </span>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            ...
                            className="flex items-center gap-2 px-5 py-3 bg-white text-green-600 rounded-2xl hover:bg-green-600 hover:text-white transition-all shadow-sm border border-gray-100 font-black text-[10px] uppercase tracking-widest"
                          >
                            EDIT
                          </button>
                          <button
                            ...
                            className="p-3 bg-white text-red-400 rounded-2xl hover:bg-red-50 hover:text-red-600 transition-all border border-gray-100"
                          >
                            <Trash2 size={18} />
                          </button>
                        </div>
              ...
              <div className="p-8 bg-gray-50 border-t border-gray-100 flex justify-center shrink-0">
                <button
                  ...
                  className="flex items-center gap-3 px-10 py-5 bg-blue-600 text-white rounded-[2rem] font-black text-xs uppercase tracking-[0.2em] shadow-xl hover:bg-blue-700 transition-all"
                >
                  TAMBAH PERTEMUAN BARU
                </button>
              </div>
