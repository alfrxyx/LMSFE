...
import { X, Camera, Mail, Phone, Lock, Save, Loader2, Sparkles } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <input 
                ...
                accept="image/*"
              />
              <p className="text-[10px] text-gray-400 text-center uppercase font-bold tracking-wider">Formal Photo (Max 2MB)</p>
            </div>
            ...
            <div className="md:col-span-2 space-y-4">
              ...
              <div className="pt-2 space-y-4">
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest border-b border-gray-100 pb-2">Change Password (Optional)</p>
